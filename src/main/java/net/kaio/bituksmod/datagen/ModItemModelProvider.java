...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.TURMALINA_HELMET);
        trimmedArmorItem(ModItems.TURMALINA_CHESTLATE);
        trimmedArmorItem(ModItems.TURMALINA_LEGGINGS);
        trimmedArmorItem(ModItems.TURMALINA_BOOTS);
    }

    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = BituksMod.MOD_ID; // Change this to your mod id
