package net.kaio.bituksmod.world.feature.tree.custom;

import com.google.common.collect.ImmutableList;
import com.mojang.serialization.Codec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import net.kaio.bituksmod.world.feature.tree.ModTrunkPlacerTypes;
...
public class RedAcaciaTrunkPlacer extends TrunkPlacer {
    public static final Codec<RedAcaciaTrunkPlacer> CODEC = RecordCodecBuilder.create(redAcaciaTrunkPlacerInstance ->
            trunkPlacerParts(redAcaciaTrunkPlacerInstance).apply(redAcaciaTrunkPlacerInstance, RedAcaciaTrunkPlacer::new));

    public RedAcaciaTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
